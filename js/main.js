...
/* -------------------------
   Marquee: px-per-sec dynamic duration
   ------------------------- */
(function() {
    ...
    function updateMarquee() {
        ...
        // We expect two identical blocks; block width is half total
        ...
        // Duration in seconds (minimum 0.5s)
        const durationSec = Math.max(0.5, blockWidth / pxPerSec);

        // Set runtime CSS vars used by animation
        ...
        // Restart CSS animation to pick up new duration immediately
